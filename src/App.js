...
function App() {
  const [text, setText] = useState('<p style="text-align:center;"><span style="color:#cccccc;"><strong>I. POSTANOWIENIA OGÓLNE</strong></span></p><ol><li>Sklep Internetowy prowadzony pod adresem internetowym <a href="https://www.dareyou.pl" target="_blank"><strong>www.dareyou.pl</strong></a><strong> </strong>prowadzony jest przez podmiot gospodarczy pod firmą Dare You Studio Andrzej Pietroczuka wpisanym do Centralnej Ewidencji i Informacji o Działalności Gospodarczej Rzeczypospolitej Polskiej prowadzonej przez ministra właściwego do spraw gospodarki, posiadającą: <strong>NIP 6030017913, REGON 200852777, </strong>adres poczty elektronicznej: <a href="mailto:biuro@jezuwdomu.pl">biuro@dareyou.pl</a>, numer telefonu:&nbsp; <strong>+48 881 575 207, </strong>KONTO BANKOWE: 25 1020 5558 0000 8702 3372 3439</li><li>kolejna linia</li></ol><h1>Nagłówek 1</h1><h2>Nagłówek 2</h2><h3>Nagłówek 3</h3><p><strong>Dowolne </strong><i>formatowanie </i><u>tekstu</u>, bezpieczne dla frontendu</p>');
  return (
    <div className="App">
